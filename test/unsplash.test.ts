import Unsplash, { toJson } from '../src';
...
describe('Unsplash', () => {
  describe('constructor', () => {
    ...
    it('should successfully construct an Unsplash instance', () => {
      expect(unsplash).toBeInstanceOf(Unsplash);
    });
  ...
  describe('auth', () => {
    ...
    describe('getAuthenticationUrl', () => {
      it('should return an authentication url', () => {
        expect(
          unsplash.auth.getAuthenticationUrl(['public', 'read_user'])
        ).toBe(
          [
      ...
      it('should default to public scope when no scope array is passed', () => {
        expect(unsplash.auth.getAuthenticationUrl()).toBe(
          [
            'https://unsplash.com/oauth/authorize',
            `?client_id=${accessKey}`,
            '&redirect_uri=http://foo.com',
  ...
  describe('users', () => {
    ...
    describe('photos', () => {
      it('should make a GET request to /users/{username}/photos', () => {
        let spy = spyOn(unsplash, 'request');
        unsplash.users.photos('naoufal', 2, 15, 'latest', {
    ...
    describe('likes', () => {
      it('should make a GET request to /users/{username}/likes', () => {
        let spy = spyOn(unsplash, 'request');
        unsplash.users.likes('naoufal', 1, 10, 'latest', {
          orientation: 'landscape',
        });
  ...
  describe('photos', () => {
    ...
    describe('likePhoto', () => {
      ...
      it('should throw is bearerToken when not set', () => {
        expect(unsplash.photos.likePhoto.bind(null, 88)).toThrow(
    ...
    describe('unlikePhoto', () => {
      ...
      it('should throw is bearerToken when not set', () => {
        expect(unsplash.photos.unlikePhoto.bind(null, 88)).toThrow(
          /Requires a bearerToken to be set./
        );
      });
    ...
    describe('downloadPhoto', () => {
      it("should make a GET request to the photo's download_location", () => {
        ...
        const mockPhotoResponse = {
          ...
          links: {
            download_location:
              'https://api.unsplash.com/photos/123123/download?ixid=drake',
          },
        };
      ...
      it('should throw an error if passed a malformed photo object', () => {
        ...
        expect(() => unsplash.photos.downloadPhoto(mockPhotoResponse)).toThrow(
    ...
    describe('trackDownload', () => {
      ...
      it('should throw an error if passed a malformed photo object', () => {
        ...
        expect(() => unsplash.photos.trackDownload(mockPhotoResponse)).toThrow(
          /Object received is not a photo/
        );
      });
    });
  ...
  describe('collections', () => {
    ...
    describe('getCollectionPhotos', () => {
      it('should make a GET request to /collections/{id}/photos', () => {
        let spy = spyOn(unsplash, 'request');
        unsplash.collections.getCollectionPhotos(88, 2, 15, 'latest', {
          orientation: 'landscape',
        });
  ...
  describe('utils', () => {
    describe('formUrlEncode', () => {
      it('should return form data', () => {
        expect(formUrlEncode({ foo: 'bar' })).toBe('foo=bar');
      });
    });
    ...
    describe('buildFetchOptions', () => {
      ...
      it('should return a fetchOptions object with a method key representing the method in the options agument', () => {
        let method = buildFetchOptions.bind(classFixture)(optionsFixture)
          .options.method;
      ...
      it('should return a fetchOptions object with `Client-ID {accessKey}` Authorization header', () => {
        let authorizationHeader = buildFetchOptions.bind(classFixture)(
          optionsFixture
      ...
      it('should return a fetchOptions object with `Bearer {token}` Authorization header', () => {
        ...
        let authorizationHeader = buildFetchOptions.bind(classBearerFixture)(
          optionsFixture
        ).options.headers['Authorization'];
      ...
      it('should return a fetchOptions object with optional header', () => {
        ...
        let optionalHeader = buildFetchOptions.bind(classBearerFixture)(
          optionsFixture
